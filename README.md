...
app/                  หน้าเว็บ (App Router) — ทุกไฟล์เป็น server component ถ้าไม่เขียน "use client"
  ...
  compare/              เทียบนักขับสองคน (?a=&b=)
  pitstops/             สถิติพิทสต็อปทั้งฤดูกาล
...
ทุกครั้งที่ widget รีเฟรชมันดึง [`public/scriptable-widget.js`](public/scriptable-widget.js)
ตัวล่าสุดจากเว็บมารันเอง แก้ widget แล้ว deploy ผู้ใช้ก็ได้ของใหม่ทันที ต่อเน็ตไม่ได้ก็ใช้
